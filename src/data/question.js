const data = [
    ...
    {
      question: "Qual das seguintes barreiras de entrada no mercado é considerada a mais difícil de superar de acordo com a teoria de Michael Porter?",
      options: [
    ...
    {
      question:
        "Qual dos seguintes elementos é essencial para o planejamento de longo prazo na Federal Express (FedEx)?",
      options: [
